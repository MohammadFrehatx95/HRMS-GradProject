...
Volume serial number is 00000241 8A82:F2A5
...
|       |       image-cropper-modal.component.ts
|       |       
|       \---sidebar
...
<div class="page-container p-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3 bg-white p-3 rounded-4 shadow-sm border border-light">
        <div class="d-flex align-items-center gap-2 flex-grow-1 flex-wrap">
            ...
            <input type="date" class="form-control bg-white shadow-sm" style="max-width: 250px;"
                [(ngModel)]="selectedDate" (change)="onFilterChange()">
            <div class="dropdown">
            ...
            <div
                ...
                <div class="form-content px-lg-3">
                    ...
                    <form [formGroup]="loginForm" (ngSubmit)="onSubmit()">
                        ...
                        <button type="submit"
                            class="btn btn-warning w-100 rounded-pill py-3 fw-bold shadow submit-btn text-dark mb-3 fs-5 d-flex justify-content-center align-items-center gap-2"
                            [disabled]="isLoading">
                            @if (isLoading) {
                        ...
                        <div class="d-flex align-items-center my-3">
                          <hr class="flex-grow-1"><span class="text-muted small px-3 fw-semibold">OR</span><hr class="flex-grow-1">
                        </div>

                        <button type="button"
                            class="btn btn-outline-secondary w-100 rounded-pill py-3 fw-bold fs-5 d-flex justify-content-center align-items-center gap-2 fingerprint-btn"
    ...
    <div id="overview" class="overview-section pb-5 position-relative z-2">
        ...
        <div class="container py-5 mt-3 mb-5">
            <div class="text-center mb-5 pb-3">
                ...
                <p class="text-white-50 lead mx-auto"
                    style="max-width: 600px; font-size: 1.25rem;">The
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <small class="text-muted fw-medium d-flex align-items-center gap-1 mt-1" style="font-size: 0.8rem;">
                                <span class="badge bg-primary bg-opacity-10 text-primary rounded-pill px-2 border border-primary border-opacity-25">{{ announcements.length }}</span> {{ 'active announcement(s)' | t }}
                            </small>
                        </div>
                    </div>
                    ...
                    <div *ngFor="let ann of announcements; let last = last" class="ann-item px-4 py-3 d-flex gap-3 align-items-start" [class.border-bottom]="!last">
                        ...
                        <div class="flex-grow-1 min-w-0">
                            <div class="d-flex align-items-center gap-2 mb-1 flex-wrap">
                                ...
                                <span class="text-muted d-inline-flex align-items-center gap-1" style="font-size: 0.72rem;">
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-md-3">
            <div class="stat-card green hover-elevate h-100 stat-card-link"
                 routerLink="/salary">
                <div class="card-body">
                    <h3>{{ totalSalaries | number }} {{ 'JD' | t }}</h3>
                    <p>{{ 'Salaries' | t }}</p>
        ...
        <div class="col-lg-8 d-flex flex-column gap-4">
                        ...
                        <table class="table table-hover align-middle mb-0 text-nowrap">
                            ...
                            <tbody class="small">
                                ...
                                <tr>
                                    ...
                                    <td class="text-success"><div class="d-inline-flex align-items-center gap-1"><i class="bi bi-box-arrow-in-right"></i>{{ att.clockIn || '--:--' }}</div></td>
                                    <td class="text-danger"><div class="d-inline-flex align-items-center gap-1"><i class="bi bi-box-arrow-right"></i>{{ (att.clockOut && att.clockOut !== '00:00:00') ? att.clockOut : '--:--' }}</div></td>
                                </tr>
                                } @empty {
                                <tr>
            ...
            <div class="chart-card card hover-elevate shadow-sm border-0 rounded-4 flex-grow-1">
                <div class="card-header bg-white p-3 border-0 pb-0 d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-light text-success border border-success border-opacity-25 px-2 py-1 d-inline-flex align-items-center gap-1"><i class="bi bi-person-check-fill"></i>{{ attendanceRate }}% {{ 'Overall' | t }}</span>
                </div>
            ...
            <div class="activity-card hover-elevate bg-white rounded-4 shadow-sm p-4 flex-grow-1">
                ...
                <div class="d-flex flex-column gap-2">
                    ...
                    <div class="d-flex align-items-center justify-content-between py-2 px-3 rounded-3 bg-light gap-2">
                        ...
                        <span class="status-badge px-2 py-1 flex-shrink-0 d-inline-flex align-items-center gap-1" style="font-size: 11px;"
                            [ngClass]="{
    ...
    <div class="row g-4 mb-4">
        <div class="col-12">
            <div class="card shadow-sm border-0 rounded-4 p-5 text-center">
                <i class="bi bi-person-lines-fill text-primary mb-3" style="font-size: 4rem;"></i>
                <h4 class="fw-bold mb-3">{{ 'Welcome to Kawadir HRMS' | t }}</h4>
                <p class="text-muted lead mx-auto" style="max-width: 600px;">
                    {{ 'Your account has been successfully registered. Please wait for the HR department to finalize your employee profile setup. Once your profile is activated, you will automatically gain access to all the system features.' | t }}
                </p>
                <div class="d-flex justify-content-center mt-4">
                    <button class="btn btn-outline-primary px-4 py-2 rounded-pill shadow-sm" routerLink="/my-profile">
                        <i class="bi bi-person me-2"></i>{{ 'Go to My Profile' | t }}
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-md-3">
            <div class="stat-card pink hover-elevate h-100 stat-card-link" routerLink="/attendance">
                <div class="card-body">
                    <h3>{{ employeeHoursWorked }} <span class="fs-6 fw-normal">{{ 'hrs' | t }}</span></h3>
                    <p>{{ 'Total Hours' | t }}</p>
...
<div class="modal fade show" tabindex="-1" role="dialog" style="display: block; background-color: rgba(0,0,0,0.5);" *ngIf="showAnnouncementModal">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
        <div class="modal-header border-0 py-3" style="background-color: rgba(var(--bs-primary-rgb), 0.05);">
      ...
      <div class="modal-body p-4">
        <form [formGroup]="announcementForm" (ngSubmit)="submitAnnouncement()">
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-6 d-flex flex-column justify-content-end">
              <label class="form-label fw-semibold">{{ 'Expiry Date & Time' | t }}</label>
              <div class="d-flex gap-2">
                <input type="date" class="form-control shadow-sm"
                    formControlName="expiryDate" required>
                <input type="time" class="form-control shadow-sm" formControlName="expiryTime" style="max-width: 120px;" required>
              </div>
              <div *ngIf="announcementForm.get('expiryDate')?.invalid && announcementForm.get('expiryDate')?.touched" class="text-danger small mt-1">Expiry date is required</div>
              <div *ngIf="announcementForm.get('expiryTime')?.invalid && announcementForm.get('expiryTime')?.touched" class="text-danger small mt-1">Expiry time is required</div>
            </div>
          </div>
          ...
          <div class="mb-3">
            <div class="form-check form-switch mb-2">
              ...
              <label class="form-check-label fw-semibold" for="isGeneralSwitch">{{ 'General Announcement (All Employees)' | t }}</label>
            </div>
          </div>

          <div class="mb-4" *ngIf="!announcementForm.get('isGeneral')?.value">
            <label class="form-label fw-semibold">{{ 'Select Target Employees' | t }}</label>
            ...
            <div class="form-check mb-2 p-2 rounded border" style="background-color: rgba(var(--bs-primary-rgb), 0.05);">
                ...
                <label class="form-check-label fw-bold ms-2" for="selectAllAnn" style="cursor: pointer;">
                    Select All Filtered Employees
                </label>
            </div>

            <div class="border rounded p-2 overflow-auto" style="max-height: 250px; box-shadow: inset 0 1px 3px rgba(0,0,0,0.05);">
              <div class="form-check mb-2" *ngFor="let emp of filteredAnnouncementEmployees">
                ...
                <label class="form-check-label w-100 d-flex align-items-center" [for]="'empAnn' + emp.id" style="cursor: pointer;">
                  ...
                  <span class="ms-auto badge text-secondary border">{{ emp.departmentName || 'No Dept' }}</span>
                </label>
              </div>
      ...
      <div class="form-section">
        ...
        <div class="row g-3">
          ...
          <div class="col-md-6 mt-3">
            ...
            <input type="date" class="form-control field-input shadow-sm"
        ...
        <div class="row g-3">
          <div class="col-12 mb-2">
            <div class="d-flex align-items-center justify-content-between p-3 bg-light rounded-3 border">
              <div>
                <h6 class="mb-1 fw-bold text-dark"><i class="bi bi-shield-check text-success me-2"></i>Account Status</h6>
                <p class="mb-0 text-muted small">Determine if this employee is currently active in the system.</p>
              </div>
              <div class="form-check form-switch fs-4 mb-0">
                <input class="form-check-input" type="checkbox" formControlName="isActive" role="switch" style="cursor: pointer;">
              </div>
            </div>
          </div>
          <div class="col-md-4">
        ...
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            ...
            <div class="modal-body p-4">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6">
                        <div class="detail-item">
                            <span class="detail-label"><i class="bi bi-gift me-1"></i>Date of Birth</span>
                            <span class="detail-value">{{ selectedEmployeeProfile?.birthDate | date:'mediumDate' }}</span>
                        </div>
                    </div>
                </div>
                <h6 class="detail-section-title">
...
### File: src\app\features\events\events.component.html
```html
<div class="d-flex justify-content-between align-items-start mb-4 flex-wrap gap-3">
  <div class="d-flex align-items-center mt-1">
    <div class="icon-box bg-success-subtle text-success rounded-3 d-flex align-items-center justify-content-center me-3" style="width: 48px; height: 48px;">
      <i class="bi bi-calendar-event fs-4"></i>
    </div>
    <div>
      <h2 class="fw-bold text-dark mb-1">{{ 'Upcoming Events & Occasions' | t }}</h2>
  ...
  <div class="d-flex gap-2">
    <button class="btn btn-success shadow-sm px-3 px-md-4 py-2 rounded-3 fw-semibold" data-bs-toggle="modal" data-bs-target="#addEventModal">
      <i class="bi bi-plus-lg me-1"></i> {{ 'Add Event' | t }}
    </button>
  </div>
  }
</div>
...
<div class="text-center my-5 py-5">
  ...
  <p class="mt-2 text-muted">{{ 'Loading events...' | t }}</p>
</div>
} @else {
  @if (events.length === 0) {
    <div class="card border-0 shadow-sm rounded-4 text-center py-5">
      <div class="card-body">
        ...
        <h4 class="fw-bold text-dark">{{ 'No upcoming events' | t }}</h4>
        <p class="text-muted">{{ 'There are no events scheduled for the next 60 days.' | t }}</p>
      </div>
    </div>
  } @else {
    <div class="row g-4">
              ...
              <div class="d-flex align-items-center mb-3">
                @if (event.eventType === 'Birthday') {
                  <div class="me-3" style="width: 50px; height: 50px;">
                    <img *ngIf="event.imageUrl" [src]="event.imageUrl" class="rounded-circle w-100 h-100 object-fit-cover shadow-sm">
                    <div *ngIf="!event.imageUrl" class="rounded-circle bg-light text-primary d-flex align-items-center justify-content-center w-100 h-100 fw-bold shadow-sm">
                      {{ getEmpInitials(event.title) }}
                    </div>
                  </div>
                } @else {
                  <div class="me-3 rounded-circle bg-light text-success d-flex align-items-center justify-content-center shadow-sm" style="width: 50px; height: 50px;">
                ...
                <div>
                  ...
                  <div class="text-primary fw-medium small">
                    ...
                    <span class="badge bg-danger-subtle text-danger ms-2">{{ getDaysLabel(getDaysUntil(event.eventDate)) | t }}</span>
                  </div>
                </div>
              </div>
    ...
    <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
      <div class="modal-header border-0 bg-success text-white p-4">
        <h5 class="modal-title fw-bold">
          <i class="bi bi-calendar-plus me-2"></i> {{ 'Add New Event' | t }}
        </h5>
      ...
      <div class="modal-body p-4">
        <form (ngSubmit)="addEvent()">
          <div class="mb-3">
            <label class="form-label fw-semibold text-muted small">{{ 'Event Title' | t }} <span class="text-danger">*</span></label>
            <input type="text" class="form-control rounded-3" [(ngModel)]="newEvent.title" name="title" required placeholder="e.g. Annual Company Party">
          </div>
          <div class="mb-3">
            <label class="form-label fw-semibold text-muted small">{{ 'Event Date' | t }} <span class="text-danger">*</span></label>
            <input type="date" class="form-control bg-light rounded-3 shadow-sm"
                [(ngModel)]="newEvent.eventDate" name="eventDate" required>
          </div>
          <div class="mb-3">
            <label class="form-label fw-semibold text-muted small">{{ 'Description' | t }}</label>
            <textarea class="form-control rounded-3" [(ngModel)]="newEvent.description" name="description" rows="3" placeholder="Additional details..."></textarea>
          </div>
        </form>
      </div>
      <div class="modal-footer border-0 p-4 bg-light">
        <button type="button" class="btn btn-outline-secondary rounded-pill px-4" data-bs-dismiss="modal">{{ 'Cancel' | t }}</button>
        <button type="button" class="btn btn-success rounded-pill px-4" (click)="addEvent()" [disabled]="isSubmitting || !newEvent.title || !newEvent.eventDate">
          @if (isSubmitting) {
            <span class="spinner-border spinner-border-sm me-2"></span>{{ 'Saving...' | t }}
          } @else {
            <i class="bi bi-check-lg me-1"></i> {{ 'Save Event' | t }}
          }
        </button>
      </div>
    </div>
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-end align-items-center mb-4 flex-wrap gap-3 bg-white p-3 rounded-4 shadow-sm border border-light">
        <div class="d-flex gap-2">
            ...
            <button class="btn btn-outline-success shadow-sm px-3 px-md-4 py-2 rounded-3 fw-semibold text-nowrap d-flex align-items-center gap-2" (click)="exportToExcel()" title="Export to Excel">
                <i class="bi bi-file-earmark-excel-fill"></i> 
                <span class="d-none d-md-inline">{{ 'Export to Excel' | t }}</span>
            </button>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        @for (group of paginatedGroupedMeetings; track group.meetLink) {
                        <tr>
                            <td class="ps-4">
                                <div class="fw-bold text-dark">{{ group.title }}</div>
                                <div class="small text-muted text-truncate" style="max-width: 250px;">{{ group.reason }}</div>
                            </td>
                            <td>
                                <span class="fw-medium text-dark">{{ group.organizerName }}</span>
                            </td>
                            <td>
                                <ng-container *ngIf="group.attendees.length > 1; else singleAttendee">
                                    <div class="dropdown">
                                        <button class="btn btn-light btn-sm rounded-pill fw-semibold dropdown-toggle d-flex align-items-center gap-2" type="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-boundary="window">
                                            <i class="bi bi-people-fill text-primary"></i> 
                                            {{ group.attendees.length }} {{ 'Employees' | t }}
                                        </button>
                                        <ul class="dropdown-menu shadow-sm border-0 rounded-3">
                                            <li *ngFor="let attendee of group.attendees">
                                                <span class="dropdown-item d-flex align-items-center gap-2">
                                                    <i class="bi bi-person-circle text-muted"></i> {{ attendee }}
                                                </span>
                                            </li>
                                        </ul>
                                    </div>
                                </ng-container>
                                <ng-template #singleAttendee>
                                    <div class="d-flex align-items-center gap-2">
                                        <i class="bi bi-person-circle text-primary fs-5"></i>
                                        <span class="fw-medium text-dark">{{ group.attendees[0] }}</span>
                                    </div>
                                </ng-template>
                            </td>
                            <td>
                                <div class="d-flex align-items-center gap-2"><i class="bi bi-calendar-event text-muted"></i>{{ group.scheduledAt | date:'mediumDate' }}</div>
                                <div class="small text-muted d-flex align-items-center gap-2"><i class="bi bi-clock"></i>{{ group.scheduledAt | date:'shortTime' }} <span *ngIf="group.durationMinutes">({{ group.durationMinutes }} min)</span></div>
                            </td>
                            <td>
                                <span class="badge rounded-pill px-3 py-2" [ngClass]="getStatusBadgeClass(group.status)">
                                ...
                                <div class="d-flex align-items-center justify-content-end gap-2">
                                    <ng-container *ngIf="isHrOrAdmin && group.status === 'Scheduled'">
                                        <button
                                            ...
                                            (click)="updateGroupStatus(group, MeetingStatus.Completed)"
                                            title="Mark Completed">
                                            <i class="bi bi-check2-circle"></i>
                                            <span class="small">{{ 'Done' | t }}</span>
                                        </button>
                                        <button
                                            class="btn btn-danger btn-sm rounded-pill d-inline-flex align-items-center gap-1 px-3"
                                            (click)="updateGroupStatus(group, MeetingStatus.Cancelled)"
                ...
                <form [formGroup]="addForm" (ngSubmit)="onSubmit()">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control bg-light shadow-sm"
                                formControlName="meetingDate" required>
                        </div>
                        <div class="col-md-6 mb-3">
      ...
      <div class="card-body p-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
          <h5 class="fw-bold text-secondary mb-0">
            <i class="bi bi-fingerprint me-2 text-primary"></i>{{ 'Fingerprint Logins' | t }}
          </h5>
          <button class="btn btn-sm btn-outline-primary rounded-pill px-3" (click)="addFingerprint()">
            <i class="bi bi-plus-lg me-1"></i> Add New
          </button>
        </div>
        
        <div *ngIf="isLoadingFingerprints" class="text-center py-3">
          <span class="spinner-border spinner-border-sm text-primary"></span>
        </div>
        
        <div *ngIf="!isLoadingFingerprints && fingerprints.length === 0" class="alert alert-light text-center rounded-3 border">
          <i class="bi bi-info-circle text-muted mb-2 d-block fs-4"></i>
          <p class="text-muted small mb-0">No fingerprints registered yet.</p>
        </div>

        <div class="row g-3" *ngIf="!isLoadingFingerprints && fingerprints.length > 0">
          <div class="col-md-6" *ngFor="let fp of fingerprints; let i = index">
            <div class="bg-light rounded-3 p-3 d-flex align-items-center justify-content-between border border-opacity-50">
              <div class="d-flex align-items-center gap-3">
                <div class="bg-white rounded p-2 text-primary shadow-sm border border-opacity-25">
                  <i class="bi bi-fingerprint fs-4"></i>
                </div>
                <div>
                  <h6 class="fw-bold mb-0 text-dark small">Fingerprint {{ fingerprints.length - i }}</h6>
                  <p class="text-muted mb-0" style="font-size: 0.75rem;">Added {{ fp.regDate | date:'mediumDate' }}</p>
                </div>
              </div>
              <button class="btn btn-sm btn-light text-danger bg-white border shadow-sm rounded-circle d-flex align-items-center justify-content-center" style="width: 32px; height: 32px;" (click)="deleteFingerprint(fp.id)" title="Remove Fingerprint">
                <i class="bi bi-trash"></i>
              </button>
            </div>
          </div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3 bg-white p-3 rounded-4 shadow-sm border border-light">
        <div class="d-flex align-items-center gap-3 flex-grow-1 flex-wrap">
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-start p-3 shadow-lg border-0 rounded-4" style="width: 250px;">
                    <h6 class="dropdown-header px-0 text-primary fw-bold mb-2">Filter Options</h6>
                    <div class="mb-3">
                        <label class="form-label small fw-semibold text-muted mb-1">{{ 'Month' | t }}</label>
                        <select class="form-select form-select-sm" [(ngModel)]="filterMonth" (change)="onFilterChange()">
                            <option value="">{{ 'All Months' | t }}</option>
                    ...
                    <div class="mb-2">
                        <label class="form-label small fw-semibold text-muted mb-1">{{ 'Year' | t }}</label>
                        <input type="number" class="form-control form-control-sm" [(ngModel)]="filterYear" (change)="onFilterChange()" placeholder="e.g. 2026">
                    </div>
                </div>
            </div>
        </div>
            ...
            <table class="table table-hover align-middle mb-0">
                <thead class="bg-light">
                    <tr>
                        ...
                        <th
                            class="py-3 px-4 text-muted small text-uppercase fw-semibold border-bottom-0">Target Month</th>
                        <th
                            class="py-3 px-4 text-muted small text-uppercase fw-semibold border-bottom-0">Status</th>
                        <th
...
<div class="page-wrapper">
  <div class="d-flex justify-content-between align-items-start mb-3 flex-wrap gap-3">
    <div class="d-flex align-items-center mt-1">
      ...
      <div>
        <h2 class="fw-bold text-dark mb-1">{{ 'Profile Picture Approvals' | t }}</h2>
...
<div class="page-container p-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-3">
        ...
        <div class="d-flex gap-2" *ngIf="isAdmin">
            ...
            <button
                class="btn btn-warning px-3 px-md-4 py-2 rounded-3 fw-semibold shadow-sm text-nowrap text-dark"
                (click)="generatePayroll()" [title]="'Generate Payroll' | t">
                <i class="bi bi-calculator" [class.me-md-1]="true"></i>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3 bg-white p-3 rounded-4 shadow-sm border border-light">
        <div class="d-flex align-items-center gap-2 flex-grow-1 flex-wrap">
            ...
            <button *ngIf="isAdminOrHR && !isAdmin"
                class="btn btn-outline-primary px-3 px-md-4 py-2 rounded-3 shadow-sm text-nowrap"
                (click)="toggleViewAll()"
                [title]="isViewingAll ? ('My Salaries' | t) : ('View All' | t)">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0 text-nowrap">
                <thead class="bg-light text-muted small text-uppercase"
                    style="letter-spacing: 0.5px;">
                    <tr>
                        <th *ngIf="isAdminOrHR && isViewingAll"
                            class="py-3 px-4 border-bottom-0 fw-semibold">{{
                            'Employee' | t }}</th>
                        <th class="py-3 px-4 border-bottom-0 fw-semibold">{{
                            'Month' | t }}/{{ 'Year' | t }}</th>
                        <th class="py-3 px-3 border-bottom-0 fw-semibold">{{
                            'Base Salary' | t }}</th>
                        <th
                            class="py-3 px-3 border-bottom-0 fw-semibold text-success">{{
                            'Allowances' | t }}</th>
                        <th
                            class="py-3 px-3 border-bottom-0 fw-semibold text-danger">{{
                            'Deductions' | t }}</th>
                        <th
                            class="py-3 px-3 border-bottom-0 fw-semibold text-primary">{{
                            'Net Pay' | t }}</th>
                        <th class="py-3 px-3 border-bottom-0 fw-semibold">{{ 'Status' | t }}</th>
                        <th
                            class="py-3 px-4 border-bottom-0 fw-semibold text-end text-nowrap">{{
                            'Actions' | t }}</th>
                    </tr>
                </thead>
                <tbody class="border-top-0">
                    <ng-container *ngIf="isLoading">
                        <tr *ngFor="let i of [1,2,3,4,5]">
                            <td *ngIf="isAdminOrHR && isViewingAll" class="py-3 px-4">
                                <div class="d-flex align-items-center">
                                    <div class="skeleton-line rounded-circle me-2" style="width: 32px; height: 32px;"></div>
                            ...
                            <td class="py-3 px-3"><div class="skeleton-line w-50"></div></td>
                            <td class="py-3 px-3"><div class="skeleton-line w-50"></div></td>
                            <td class="py-3 px-3"><div class="skeleton-line w-50"></div></td>
                            <td class="py-3 px-3">
                                <div class="skeleton-line w-75 mb-1"></div>
                            ...
                            <td class="py-3 px-3"><div class="skeleton-line w-50 rounded-pill"></div></td>
                        ...
                        <td [colSpan]="(isAdminOrHR && isViewingAll) ? 8 : 7"
                            ...
                            <div class="d-flex flex-column align-items-center">
                                <div
                                    ...
                                    <i
                                        class="bi bi-wallet2 text-secondary fs-1"></i>
                                </div>
                                <h5 class="fw-bold text-dark mb-1">{{ 'No Data'
                                    | t }}</h5>
                                <p class="text-muted small mb-0">{{ 'No Data' |
                                    t }}</p>
                            </div>
                        </td>
                    </tr>
                    <tr *ngFor="let salary of paginatedSalaries">
                        <td *ngIf="isAdminOrHR && isViewingAll"
                            ...
                            <div class="d-flex align-items-center">
                                <ng-container
                                    *ngIf="salary.employeeProfilePictureUrl; else noSalaryPic">
                                    <img
                                        [src]="salary.employeeProfilePictureUrl"
                                        alt="User"
                                ...
                                <ng-template #noSalaryPic>
                                    <div
                                        class="avatar-circle bg-primary bg-opacity-10 text-primary fw-bold me-2 rounded-circle d-flex align-items-center justify-content-center"
                                        style="width: 32px; height: 32px; font-size: 13px;">
                                        {{ salary.employeeName ?
                        ...
                        <td data-label="Actions"
                            ...
                            <button *ngIf="isAdmin && salary.status !== 'Paid'"
...
<div class="modal fade" id="salaryModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow rounded-4">
            ...
            <div class="modal-body p-4">
                <div
                    class="alert alert-info py-2 d-flex align-items-center mb-4"
                    role="alert" style="font-size: 0.85rem;">
                    <i class="bi bi-info-circle-fill me-2 fs-5"></i>
                    <div>
                        Standard allowances and unapplied adjustments
                        (bonuses/penalties) will be automatically calculated and
                ...
                <form #salaryForm="ngForm">
                        ...
                        <div
                            ...
                            <ng-container
                                *ngIf="filteredEmployeesList.length > 0; else noEmployees">
                                <button type="button"
                                    ...
                                    *ngFor="let emp of filteredEmployeesList"
                                    ...
                                    <span
                                        ...
                                        style="font-size: 11px;">ID: {{ emp.id
                                        }}</span>
                                </button>
                            </ng-container>
                            <ng-template #noEmployees>
                                <div class="text-center py-4 text-muted">
                                    <i
                                        class="bi bi-search mb-2 fs-4 text-black-50"></i>
                                    <p class="mb-0 small fw-semibold">No
                                        employees found.</p>
                                </div>
                            </ng-template>
                        </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-6">
                            <label
                                class="form-label fw-semibold text-secondary small">Month
                                <span class="text-danger">*</span></label>
                            <input type="number"
                                class="form-control bg-light border-0"
                                name="month"
                                [(ngModel)]="salaryData.month" required min="1"
                                max="12">
                        </div>
                        <div class="col-6">
                            <label
                                class="form-label fw-semibold text-secondary small">Year
                                <span class="text-danger">*</span></label>
                            <input type="number"
                                class="form-control bg-light border-0"
                                name="year"
                                [(ngModel)]="salaryData.year" required
                                min="2000">
                        </div>
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="row mb-4">
                        <div class="col-6">
                            <label
                                class="form-label fw-semibold text-success small">Additional
                                Allowances
                                (+) <span class="text-danger">*</span></label>
                            <input type="number"
                                class="form-control border-success border-opacity-25 bg-light"
                                name="allowances"
                                [(ngModel)]="salaryData.allowances" required
                                min="0">
                        </div>
                        <div class="col-6">
                            <label
                                class="form-label fw-semibold text-danger small">Additional
                                Deductions
                                (-) <span class="text-danger">*</span></label>
                            <input type="number"
                                class="form-control border-danger border-opacity-25 bg-light"
                                name="deductions"
                                [(ngModel)]="salaryData.deductions" required
                                min="0">
                        </div>
                    </div>
                    <div class="mb-2">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            <div class="modal-header bg-warning text-dark border-0 py-3">
                <h5 class="modal-title fw-bold" id="payrollWizardModalLabel">
                    <i class="bi bi-magic me-2"></i>{{ 'Payroll' | t }}
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"
                    aria-label="Close"></button>
            </div>
            <div class="modal-body p-4 bg-light">
                ...
                <div *ngIf="wizardStep === 1">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <label
                                class="form-label fw-semibold text-secondary small">Month</label>
                            <input type="number" class="form-control"
                                [(ngModel)]="previewMonth" min="1" max="12">
                        </div>
                        <div class="col-md-4">
                            <label
                                class="form-label fw-semibold text-secondary small">Year</label>
                            <input type="number" class="form-control"
                                [(ngModel)]="previewYear" min="2000" max="2100">
                        </div>
                        <div class="col-md-4">
                            <label
                                class="form-label fw-semibold text-secondary small">Department
                                (Optional)</label>
                            <select class="form-select"
                                [(ngModel)]="previewDepartmentId">
                                <option [ngValue]="null">All
                                    Departments</option>
                                <option *ngFor="let d of departments"
                                    [ngValue]="d.id">{{ d.name }}</option>
                            </select>
                        </div>
                    </div>
                </div>
                                ...
                                <tbody>
                                    <tr *ngFor="let s of previewData.salaries" [ngClass]="{'opacity-50 bg-light': excludedEmployees.has(s.employeeId)}">
                                        ...
                                        <td class="text-success">+{{
                                            s.allowances | currency:'JD '
                                            }}</td>
                                        <td class="text-danger">-{{ s.deductions
                                            | currency:'JD ' }}</td>
            ...
            <div class="modal-footer border-0 bg-light">
                <button type="button" class="btn btn-light"
                    data-bs-dismiss="modal">Cancel</button>
                <button *ngIf="wizardStep === 1" type="button"
                    class="btn btn-primary px-4"
                    (click)="previewPayroll()" [disabled]="isPreviewLoading">
                    <span *ngIf="isPreviewLoading"
                        class="spinner-border spinner-border-sm me-2"></span>
                    Preview
                </button>
                <button *ngIf="wizardStep === 2" type="button"
                    class="btn btn-success px-4"
                    (click)="confirmGeneratePayroll()"
                    [disabled]="isPreviewLoading || previewData?.salaries?.length === 0">
                    <span *ngIf="isPreviewLoading"
                        class="spinner-border spinner-border-sm me-2"></span>
                    ...
                    <li>
                        <a class="dropdown-item py-3 border-bottom"
                            ...
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    <button *ngIf="!note.isRead" class="btn btn-link p-0 me-2 unread-indicator" (click)="markAsRead(note, $event)" title="Mark as read">
    ...
    <nav class="sidebar-nav">
        <ul>
            ...
            <li><a routerLink="/events" routerLinkActive="active"
                    (click)="closeMobileSidebar()"><i
                        class="bi bi-calendar-heart icon-teal"></i> {{
                    'Events & Birthdays' | t
                    }}</a></li>
