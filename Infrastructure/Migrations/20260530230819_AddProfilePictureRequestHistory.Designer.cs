...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260530230819_AddProfilePictureRequestHistory")]
    partial class AddProfilePictureRequestHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.CompanyEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.LeaveSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("DefaultAnnualLeave")
                        .HasColumnType("integer");

                    b.Property<int>("DefaultEmergencyLeave")
                        .HasColumnType("integer");

                    b.Property<int>("DefaultSickLeave")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.ProfilePictureRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("RequestedPictureUrl")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("ProfilePictureRequests");
                });
            ...
            modelBuilder.Entity("Domain.Entities.ProfilePictureRequest", b =>
                {
                    b.HasOne("Domain.Entities.User", "User")
                        .WithMany("ProfilePictureRequests")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.Navigation("ProfilePictureRequests");
                });
